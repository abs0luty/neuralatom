...
class ClusterCountPredictor(torch.nn.Module):
    ...
    def forward(
        ...
        # Count valid nodes per graph and derive per-graph bounds
        ...
        # Apply per-graph limits so we never request more clusters than nodes
        ...
        # Provide differentiable ratio for training/logging
